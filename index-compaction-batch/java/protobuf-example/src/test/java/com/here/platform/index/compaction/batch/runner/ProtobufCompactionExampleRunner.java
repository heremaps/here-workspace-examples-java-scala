 ...
 * `protobuf-example/src/test/resources/pipeline-config.conf`
 * `protobuf-example/src/main/resources/application.conf`
 * `protobuf-example/src/test/resources/credentials.properties`
 */
public class ProtobufCompactionExampleRunner {
