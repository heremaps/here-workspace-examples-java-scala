...
package com.here.platform.index.compaction.batch.util;
...
public class CustomProtoWriteSupport<T extends MessageOrBuilder> extends WriteSupport<T> {
  ...
  public CustomProtoWriteSupport() {}

  public CustomProtoWriteSupport(Class<? extends Message> protobufClass) {
  ...
  public WriteContext init(Configuration configuration) {
    ...
    // if no protobuf descriptor was given in constructor, load descriptor from configuration (set
    // with setProtobufClass)
  ...
  private void validatedMapping(Descriptor descriptor, GroupType parquetSchema) {
    ...
    for (FieldDescriptor fieldDescriptor : allFields) {
      ...
      if (fieldIndex != parquetIndex) {
        String message =
            "FieldIndex mismatch name=" + fieldName + ": " + fieldIndex + " != " + parquetIndex;
