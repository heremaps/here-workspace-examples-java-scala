...
- [java-flink-stream-path-matcher](java/flink/stream-path-matcher/README.md)
  ...
  pipeline.
- [scala-spark-infer-stop-signs-from-sensors_2.13](scala/spark/infer-stop-signs-from-sensors/README.md)
...
- [scala-standalone_2.13](scala/standalone/README.md) uses the Scala high level
...
[Data User Guide](https://docs.here.com/data-api/docs/layer-creating).
...
[Identity & Access Management Developer Guide](https://docs.here.com/identity-and-access-management/docs/readme).
...
see
[OLP CLI](https://docs.here.com/workspace/docs/olp-cli-readme).
...
[Get Your Credentials](https://docs.here.com/identity-and-access-management/docs/readme).
...
[Share a Catalog](https://docs.here.com/data-api/docs/catalog-sharing).
