...
olp pipeline template create $PIPELINE_TEMPLATE_NAME batch-2.1.0 $PATH_TO_JAR \
            com.here.platform.data.validation.example.quickstart.testing.java.Main \
...
Alternatively you can inspect the following catalog in the **Data** tab: hrn:{here_value}:data::{realm}:dvl-example-berlin4-validation-quickstart-java-testing
