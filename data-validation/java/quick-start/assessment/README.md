...
```bash
olp pipeline template create $PIPELINE_TEMPLATE_NAME batch-2.1.0 $PATH_TO_JAR com.here.platform.data.validation.example.quickstart.assessment.java.Main $GROUP_ID --input-catalog-ids quickstartmetrics quickstartinput
```
