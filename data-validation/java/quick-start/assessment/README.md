...
Alternatively you can inspect the following catalog in the **Data** tab: hrn:{here_value}:data::{realm}:dvl-example-berlin4-validation-quickstart-java-assessment
