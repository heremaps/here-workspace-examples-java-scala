...
import com.here.platform.data.validation.core.assessment.criteria.families.SingleCriteria
import com.here.platform.schema.data.validation.example.quickstart.assessment.v1.assessment.Assessment

/** Example CriteriaFamily implementation that has a single criteria.
  *
  */
