...
In this example, the incremental [RefTreeCompiler](https://docs.here.com/workspace/docs/dpl-topics-functional-patterns#reftreecompiler) functional pattern is used,
...
For more information about `RefTreeCompiler` functional pattern, see the [`Data Processing Library Developer Guide`](https://docs.here.com/workspace/docs/dpl-topics-functional-patterns#reftreecompiler).
...
For more details on how to set up your credentials, see [Identity & Access Management Developer Guide](https://docs.here.com/identity-and-access-management/docs/readme).
...
[Maven Archetypes for schema projects](https://docs.here.com/workspace/docs/tutorials-proto-schema-readme#use-maven-archetype).
