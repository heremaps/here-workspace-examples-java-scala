...
In this example, the incremental [RefTreeCompiler](https://www.here.com/docs/bundle/data-processing-library-developer-guide-scala-java/page/topics/functional-patterns.html#reftreecompiler) functional pattern is used,
...
The implemented compiler takes HERE Map Content input data from the `topology-attributes` and `topology-geometry` layers, finds all pedestrian topologies, and produces output
tiles in Protobuf Format. The output of this compiler is the `pedestriansegments` layer Protobuf
HERE Tile format.

For more information about `RefTreeCompiler` functional pattern, see the [`Data Processing Library Developer Guide`](https://www.here.com/docs/bundle/data-processing-library-developer-guide-scala-java/page/topics/functional-patterns.html#reftreecompiler).
...
For more details on how to set up your credentials, see [Identity & Access Management Developer Guide](https://www.here.com/docs/bundle/identity-and-access-management-developer-guide/page/README.html).
...
[Maven Archetypes for schema projects](https://www.here.com/docs/bundle/here-workspace-developer-guide-java-scala/page/proto-schema/README.html#use-maven-archetype).
