...
/**
 * Convenient wrapper to store all information that allow load concrete partition i.e. {@link
 * com.here.platform.data.processing.java.blobstore.Retriever#getPayload(Key, Meta)}
 */
