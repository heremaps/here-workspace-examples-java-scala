...
We use [DeltaSets](https://docs.here.com/workspace/docs/dpl-topics-deltasets) in this example that are a new distributed processing abstraction provided by the [`Data Processing Library`](https://docs.here.com/workspace/docs/dpl-readme).
