...
We use [DeltaSets](https://developer.here.com/documentation/data-processing-library/dev_guide/topics/deltasets.html) in this example that are a new distributed processing abstraction provided by the [`Data Processing Library`](https://developer.here.com/documentation/data-processing-library/dev_guide/index.html).
