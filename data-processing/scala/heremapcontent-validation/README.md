...
[project](https://docs.here.com/identity-and-access-management/docs/manage-projects).
...
[`olp project create`](https://docs.here.com/workspace/docs/olp-cli-topics-project-project-commands#create-project) command to create the project:

```bash
olp project create $PROJECT_ID $PROJECT_NAME
```

The command returns the [HERE Resource Name (HRN)](https://docs.here.com/data-api/docs/catalogs#here-resource-names-hrn) of your new project. Note down this HRN as you'll need it later in this tutorial.
