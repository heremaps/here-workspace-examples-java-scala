...
/**
  ...
  * <a href="https://www.here.com/docs/bundle/data-processing-library-developer-guide-scala-java/page/topics/functional-patterns.html#direct-1n-and-mn-compilers">Direct compilers</a>.
...
class Compiler(ctx: DriverContext)
  ...
  /**
    ...
    * <a href="https://www.here.com/docs/bundle/data-processing-library-developer-guide-scala-java/page/topics/partitioners-spark-additions.html">Overview of available partitioners</a>.
  ...
  /**
    ...
    * <a href="https://www.here.com/docs/bundle/data-processing-library-developer-guide-scala-java/page/topics/configuration.html">configuration page</a>
