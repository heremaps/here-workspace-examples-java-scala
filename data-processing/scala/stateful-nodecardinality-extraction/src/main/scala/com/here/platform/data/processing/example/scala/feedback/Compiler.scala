...
/**
  ...
  * <a href="https://docs.here.com/workspace/docs/dpl-topics-functional-patterns#direct-1n-and-mn-compilers">Direct compilers</a>.
...
class Compiler(ctx: DriverContext)
  ...
  /**
    ...
    * <a href="https://docs.here.com/workspace/docs/dpl-topics-partitioners-spark-additions">Overview of available partitioners</a>.
  ...
  /**
    ...
    * <a href="https://docs.here.com/workspace/docs/dpl-topics-configuration">configuration page</a>
